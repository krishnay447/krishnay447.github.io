...
.cert-frame:hover { transform: scale(1.03) rotate(1deg); }
  ...
  <div class="patent-card">
    <div class="patent-info">
      ...
      <div class="meta-item">
        ...
        <div>
          <strong>Team:</strong> 
          S. Sarkar, T.K. Ghosh, S. Sarkar, M. Jha, S. Guchhait, K. Sood, <span class="no-wrap-name"><b>Krishna Yadav</b></span>, Ankush
        </div>
      </div>
    ...
    <div class="patent-visual">
      <a href="/assets/Patent1.jpg" target="_blank">
        <img src="/assets/Patent1.jpg" class="cert-frame" alt="Certificate 1" onerror="this.src='https://via.placeholder.com/400x550?text=Patent+1+Image'">
      </a>
    </div>
  </div>
  ...
  <div class="patent-card">
    <div class="patent-info">
      ...
      <div class="meta-item">
        ...
        <div>
          <strong>Team:</strong> 
          S. Sarkar, N. Kundu, T.K. Ghosh, M. Jha, S.K. Guchhait, <span class="no-wrap-name"><b>Krishna Yadav</b></span>, Sunaina, A. Arora
        </div>
      </div>
    ...
    <div class="patent-visual">
      <a href="/assets/Patent2.jpg" target="_blank">
        <img src="/assets/Patent2.jpg" class="cert-frame" alt="Certificate 2" onerror="this.src='https://via.placeholder.com/400x550?text=Patent+2+Image'">
      </a>
    </div>
  </div>
