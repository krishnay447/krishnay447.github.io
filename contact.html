...
<style>
  ...
  :root { --primary:#1e88e5; --primary-dark:#1565c0; --nav-hover:#e3f2fd; --bg:#f7f9fc; --border:#dce3ef; --ink:#2a3440; }
  ...
  .nav-bar a, .dropdown-toggle { text-decoration: none; color: var(--primary-dark) !important; font-weight: 800; padding: 6px 12px; border-radius: 8px; transition: 0.2s; display: inline-flex; align-items: center; gap: 5px; cursor: pointer; border: none; background: none; }
  ...
  #map { width: 100%; height: 400px; border-radius: 12px; border: 1px solid var(--border); margin-top: 15px; }
...
<div class="grid-container">
  <aside class="profile-card">
    ...
    <h2 style="font-size:22px; font-weight:800; margin:0;">Dr. Krishna Kumar Yadav</h2>
    <p>Postdoctoral Fellow</p>
    <a href="mailto:Krish91phy@usal.es" style="background:var(--primary); color:white; padding:8px 16px; border-radius:20px; text-decoration:none;"><i class="fas fa-envelope"></i> Krish91phy@usal.es</a>
  </aside>

  <section class="map-card">
    <h3 style="margin-top:0; color:var(--primary-dark);">📍 Research Network</h3>
    <div id="map"></div>
...
<div style="position: fixed; bottom: 20px; right: 20px; z-index: 9999; background: white; padding: 10px; border-radius: 8px; border: 1px solid var(--border);">
  <script type="text/javascript">
    var sc_project=13250871; var sc_invisible=0; var sc_security="d8d12d18";
    document.write("<script src='https://statcounter.com/counter/counter.js'></"+"script>");
  </script>
</div>
...
<script>
  window.initMap = function() {
    var map = new mappls.Map('map', { center: [30, 40], zoom: 3 });
