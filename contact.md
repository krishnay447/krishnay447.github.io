...
<div class="grid-container">
  <aside class="profile-card">
    ...
    <div style="font-size:16px; font-style:italic; font-weight:700; color:var(--primary-dark); margin-bottom:15px;">University of Salamanca</div>
  ...
  <section class="map-card">
    ...
    <div id="map" style="width: 100%; height: 400px; position: relative; border-radius: 12px; border: 1px solid var(--border);"></div>
