...
/* DIFFERENT STYLE: Split Grid Layout */
...
.profile-img { width: 180px; height: 180px; border-radius: 50%; object-fit: cover; border: 5px solid var(--nav-hover); margin-bottom: 20px; }
.name-text { font-size: 24px; font-weight: 800; color: var(--ink); margin-bottom: 10px; }
.dept-style { font-size: 17px; font-style: italic; font-weight: 600; color: var(--primary-dark); margin-bottom: 20px; }
</style>
...
<div class="grid-container">
  <aside class="profile-card">
    <img src="/assets/profile.jpg" class="profile-img" alt="Krishna Yadav">
    <h2 class="name-text">Dr. Krishna Kumar Yadav</h2>
    <p>Postdoctoral Fellow</p>
    <div class="dept-style"><i>Department of Fundamental Physics, University of Salamanca</i></div>
    <a href="mailto:Krish91phy@usal.es" style="display:inline-block; margin-top:15px; padding:10px 20px; background:var(--primary); color:white; border-radius:30px; text-decoration:none; font-weight:700;">
  ...
  <section class="map-card">
    ...
    <div style="width:100%; height:320px; background:#f0f4f8; display:flex; align-items:center; justify-content:center; border-radius:12px; margin-top:15px;">
