  ...
  <div class="map-right">
    ...
    <div class="map-container">
      ...
      <a href="https://gorakhpur.nic.in/" target="_blank" title="Gorakhpur, India">
        <svg class="map-pin" style="top: 31.3%; left: 68.5%;" viewBox="0 0 24 24" fill="#FF9933">
          <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
        </svg>
      </a>

      <a href="https://www.inst.ac.in/" target="_blank" title="INST Mohali, India">
        <svg class="map-pin" style="top: 30.2%; left: 66.5%;" viewBox="0 0 24 24" fill="#FFFFFF">
          <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
        </svg>
      </a>

      <a href="https://en.sce.ac.il/" target="_blank" title="SCE, Israel">
        <svg class="map-pin" style="top: 24.2%; left: 55.45%;" viewBox="0 0 24 24" fill="#2E8B57">
          <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
        </svg>
      </a>

      <a href="https://lbt.usal.es/" target="_blank" title="LBT, Univ. de Salamanca">
        <svg class="map-pin pin-active" style="top: 21.2%; left: 44%;" viewBox="0 0 24 24">
          <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
        </svg>
      </a>
    </div>
